...
MainFrame::MainFrame(Client *&a, wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxFrame(parent, id, title, pos, size, style)
{
    ...
    InputIDTextBox = new wxBoxSizer(wxVERTICAL);
    ...
    SearchButtonBox = new wxBoxSizer(wxHORIZONTAL);
    ...
    mainBox->Add(controlBox, 1, wxALIGN_CENTER, 5);

    wxBoxSizer *listMatchBox;
    listMatchBox = new wxBoxSizer(wxVERTICAL);
    ...
    listMatchBox->Add(LIST_MATCH, 0, wxALIGN_CENTER | wxALL, 5);

    mainBox->Add(listMatchBox, 1, wxALIGN_CENTER, 5);
    ...
    LIST_MATCH->Connect(wxEVT_GRID_LABEL_LEFT_DCLICK, wxGridEventHandler(MainFrame::OnSearchDetailsClick), NULL, this);
}
...
MainFrame::~MainFrame()
{
    ...
    LIST_MATCH->Disconnect(wxEVT_GRID_LABEL_LEFT_DCLICK, wxGridEventHandler(MainFrame::OnSearchDetailsClick), NULL, this);
}
...
void MainFrame::OnSearchDetailsClick(wxGridEvent &event)
{
    // Check if the client is admin
